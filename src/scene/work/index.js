...
class WorkItemView extends Component {
    ...
    showContentImage(file) {
        ...
        switch(file.type.toUpperCase()){
            case 'PDF':
                this.setState({workContent: sample_pdf, isLoading: false})
                break
            case 'VIDEO':
            ...
            case 'MP3':
                ...
                break
            case 'WORD':
                this.setState({workContent: sample_word, isLoading: false})
                break
            default:                
                ...
                </header>
                {
                    ...
                    :<div id="item-viewer-container" className={this.state.isDrawing ? 'bar-open' : null}>
                        <section className="item-viewer">
                             <div className={this.state.OwnProject === null ? 'item-viewer-inner' : 'item-viewer-inner with-nav'}>
                                ...
                                {              
                                    ...
                                    <img alt="" src={loadingIcon} width={50} height={50} />
                                    ...
                                    :
                                    <div className="full-item" style={{backgroundImage: "url(" + this.state.workContent + ")" }}></div>
                                }
                                </div>
                                    ...
                                    <section className="annotation-list">
                                        {
                                            ...
                                            :
                                            <FeedbackList data={file.comments} ownPrjoect={false} handle={_this.props} onDeleteComment={(key) => this.onDeleteComment(key)} onPreviewImage={(url) => this.onPreviewImage(url)}/>
                                        }
                                    </section>
                                    :
